class Weather {
  ...
  Weather() {
    processing.data.JSONObject w = loadJSONObject(baseURL + city);
  ...
  void display(int x, int y) {
    fill(0);
    processing.data.JSONObject f = forecasts.getJSONObject(0);
    ...
    processing.data.JSONObject i = f.getJSONObject("image");
